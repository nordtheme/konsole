...
Implemented the main `.colorscheme` color scheme file [`nord.colorscheme`](https://github.com/nordtheme/konsole/blob/develop/src/nord.colorscheme). (@svengreb, #1, 5e319fdf)

Implementd a [`install.sh`](https://github.com/nordtheme/konsole/blob/develop/install.sh) shell script for an automated installation . (@svengreb, #2, 7f8c219a)

Detailed information about features and install instructions can be found in the [README](https://github.com/nordtheme/konsole/blob/develop/README.md#installation) and in the [project wiki](https://github.com/nordtheme/konsole/wiki).

<p align="center">
  <picture>
    <img src="https://raw.githubusercontent.com/nordtheme/konsole/develop/src/assets/scrot-colortest.png" /><br />
  </picture>
